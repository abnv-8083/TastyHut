...
const TableGrid = ({ tables, searchQuery, onSearchChange, onTableClick, activeOrders, onAdd }) => {
                ...
                {filteredTables.map(table => {
                    ...
                    return (
                        <div
                            ...
                            className={`p-6 rounded-3xl flex flex-col items-center justify-center gap-3 cursor-pointer transition-all active:scale-95 glass border
                            ${order
